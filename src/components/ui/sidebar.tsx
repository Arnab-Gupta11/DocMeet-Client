    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-secondary-bg-light-2 dark:bg-secondary-bg-dark-2 text-sidebar-foreground xsm:w-[320px] sm:w-[400px] p-0 [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="bg-secondary-bg-light-2 dark:bg-secondary-bg-dark-1 group-data-[variant=floating]:border-sky-100 dark:group-data-[variant=floating]:border-dark-primary-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
